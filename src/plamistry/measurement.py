...
def measure(path_to_warped_image_mini, lines):
    ...
    if (None in lines) or (len(lines) < 3):
        ...
        # TODO: Add
        create_line_length_info(heart_line_points, head_line_points, life_line_points)
        ...
        im.save("results/process/result_colored_line.jpg")

        return im, contents


# TODO: Add
def calculate_line_length(points: list):
    return sum(
...
def create_line_length_info(heart_points: list, head_points: list, life_points: list):
    heart_length = calculate_line_length(heart_points)
    head_length = calculate_line_length(head_points)
    life_length = calculate_line_length(life_points)

    # Print lengths
    # print("Heart Line Length:", heart_length)
    # print("Head Line Length:", head_length)
    # print("Life Line Length:", life_length)

    result_line_length.append(heart_length)
    result_line_length.append(head_length)
    result_line_length.append(life_length)

    # print(f"-------Heart Line Points-----------", heart_points, sep="\n")
    # print(f"-------Head Line Points-----------", head_points, sep="\n")
    # print(f"-------Life Line Points-----------", life_points, sep="\n")
