import cv2
from tkinter import Label, Tk, Button, ttk, Radiobutton, IntVar
...
combo_box.current(0)
combo_box.place(x=30, y=780, width=100)
...
def draw(event):
    global start_x, start_y, canvas_image, drawing_lines,GRadivar
...
Button(win, text="◀", bg="gray", fg="white", command=count_down).place(x=230, y=780, width=40)
Button(win, text="▶", bg="gray", fg="white", command=count_up).place(x=290, y=780, width=40)
Button(win, text="ลบ", bg="gray", fg="white", command=erase).place(x=350, y=780, width=40)
...
Button(win, text="Exit", bg="gray", fg="white", command=close_drawing).place(x=button_pos['x'] + 3 * padding_x,
                                                                             y=780, width=40)
Radiobutton(win, text="Thick = 1", variable=Radivar, value=1, command=sel).place(x=400, y=710)
Radiobutton(win, text="Thick = 2", variable=Radivar, value=2, command=sel).place(x=400, y=710+20)
Radiobutton(win, text="Thick = 3", variable=Radivar, value=3, command=sel).place(x=400, y=710+40)
